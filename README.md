...
Победы на хакатонах:
- X5 Tech 2024: 4 место | Маскирование. Детекция чувствительной информации (NER)
    Выполнил: обработка данных, написаниe регулярных выражений, создание дополнительных дата-сетов, применение библиотеки Bert(HuggingFace)
- X5 Tech 2024: 5 место | Детекция галлюцинаций
    Выполнил: обработка данных, написания регулярных выражений, применение библиотеки Bert (HuggingFace)

В настоящий момент в активном поиске работы
